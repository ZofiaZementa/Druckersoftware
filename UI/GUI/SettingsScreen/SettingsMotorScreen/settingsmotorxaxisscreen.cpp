...
void SettingsMotorXAxisScreen::uiSetup()
{
...
void SettingsMotorXAxisScreen::uiUpdateSettings()
{
...
void SettingsMotorXAxisScreen::uiUpdateValues()
{

    m_multiplierSpinBox->setValue(m_settings->value("motorsettings/xaxis/multiplier", 100.0).toReal());
    m_motoradressSpinBox->setValue(m_settings->value("motorsettings/xaxis/maximum_feedrate", 100.0).toReal());
    m_maxFeedrateSpinBox->setValue(m_settings->value("motorsettings/xaxis/motoradress", 1.0).toReal());
    m_minStepfrequenzySpinBox->setValue(m_settings->value("motorsettings/xaxis/min_stepfrequency", 0.0).toReal());
    m_phasecurrentSpinBox->setValue(m_settings->value("motorsettings/xaxis/phasecurrent", 100.0).toReal());
    m_haltPhasecurrentSpinBox->setValue(m_settings->value("motorsettings/xaxis/haltphasecurrent", 25.0).toReal());
    m_stopDeccelerationSpinBox->setValue(m_settings->value("motorsettings/xaxis/stop_decceleration", 8000.0).toReal());
    m_backlashSpinBox->setValue(m_settings->value("motorsettings/xaxis/backlash", 0.0).toReal());
    m_maxAccelerationSpinBox->setValue(m_settings->value("motorsettings/xaxis/maximum_acceleration", 500.0).toReal());
    m_maxDeccelerationSpinBox->setValue(m_settings->value("motorsettings/xaxis/maximum_decceleration", 500.0).toReal());
    m_maxAccelerationChangeSpinBox->setValue(m_settings->value("motorsettings/xaxis/maximum_acceleration_change", 100.0).toReal());
    m_maxDeccelerationChangeSpinBox->setValue(m_settings->value("motorsettings/xaxis/maximum_decceleration_change", 100.0).toReal());
    m_settings->sync();

    if(m_settings->value("motorsettings/xaxis/negative_turningdirection", 0).toInt() == 0){

        ui->negativeTurningDirectionComboBox->setCurrentIndex(0);
    }

    else if(m_settings->value("motorsettings/xaxis/negative_turningdirection", 0).toInt() == 1){

        ui->negativeTurningDirectionComboBox->setCurrentIndex(1);
    }

    if(m_settings->value("motorsettings/xaxis/positive_turningdirection", 1).toInt() == 0){

        ui->positiveTurningDirectionComboBox->setCurrentIndex(0);
    }
    else if(m_settings->value("motorsettings/xaxis/positive_turningdirection", 1).toInt() == 1){
