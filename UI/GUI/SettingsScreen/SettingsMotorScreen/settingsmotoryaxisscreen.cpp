...
void SettingsMotorYAxisScreen::uiSetup()
{
...
void SettingsMotorYAxisScreen::uiUpdateSettings()
{
...
void SettingsMotorYAxisScreen::uiUpdateValues()
{

    m_multiplierSpinBox->setValue(m_settings->value("motorsettings/yaxis/multiplier", 100.0).toReal());
    m_motoradressSpinBox->setValue(m_settings->value("motorsettings/yaxis/maximum_feedrate", 100.0).toReal());
    m_maxFeedrateSpinBox->setValue(m_settings->value("motorsettings/yaxis/motoradress", 1.0).toReal());
    m_minStepfrequenzySpinBox->setValue(m_settings->value("motorsettings/yaxis/min_stepfrequency", 0.0).toReal());
    m_phasecurrentSpinBox->setValue(m_settings->value("motorsettings/yaxis/phasecurrent", 100.0).toReal());
    m_haltPhasecurrentSpinBox->setValue(m_settings->value("motorsettings/yaxis/haltphasecurrent", 25.0).toReal());
    m_stopDeccelerationSpinBox->setValue(m_settings->value("motorsettings/yaxis/stop_decceleration", 8000.0).toReal());
    m_backlashSpinBox->setValue(m_settings->value("motorsettings/yaxis/backlash", 0.0).toReal());
    m_maxAccelerationSpinBox->setValue(m_settings->value("motorsettings/yaxis/maximum_acceleration", 500.0).toReal());
    m_maxDeccelerationSpinBox->setValue(m_settings->value("motorsettings/yaxis/maximum_decceleration", 500.0).toReal());
    m_maxAccelerationChangeSpinBox->setValue(m_settings->value("motorsettings/yaxis/maximum_acceleration_change", 100.0).toReal());
    m_maxDeccelerationChangeSpinBox->setValue(m_settings->value("motorsettings/yaxis/maximum_decceleration_change", 100.0).toReal());
    m_settings->sync();

    if(m_settings->value("motorsettings/yaxis/negative_turningdirection", 0).toInt() == 0){

        ui->negativeTurningDirectionComboBox->setCurrentIndex(0);
    }

    else if(m_settings->value("motorsettings/yaxis/negative_turningdirection", 0).toInt() == 1){

        ui->negativeTurningDirectionComboBox->setCurrentIndex(1);
    }

    if(m_settings->value("motorsettings/yaxis/positive_turningdirection", 1).toInt() == 0){

        ui->positiveTurningDirectionComboBox->setCurrentIndex(0);
    }
    else if(m_settings->value("motorsettings/yaxis/positive_turningdirection", 1).toInt() == 1){
