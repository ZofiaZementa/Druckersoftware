...
void SettingsMotorZAxisScreen::uiSetup()
{
...
void SettingsMotorZAxisScreen::uiUpdateSettings()
{
...
void SettingsMotorZAxisScreen::uiUpdateValues()
{

    m_multiplierSpinBox->setValue(m_settings->value("motorsettings/zaxis/multiplier", 100.0).toReal());
    m_motoradressSpinBox->setValue(m_settings->value("motorsettings/zaxis/maximum_feedrate", 100.0).toReal());
    m_maxFeedrateSpinBox->setValue(m_settings->value("motorsettings/zaxis/motoradress", 1.0).toReal());
    m_minStepfrequenzySpinBox->setValue(m_settings->value("motorsettings/zaxis/min_stepfrequency", 0.0).toReal());
    m_phasecurrentSpinBox->setValue(m_settings->value("motorsettings/zaxis/phasecurrent", 100.0).toReal());
    m_haltPhasecurrentSpinBox->setValue(m_settings->value("motorsettings/zaxis/haltphasecurrent", 25.0).toReal());
    m_stopDeccelerationSpinBox->setValue(m_settings->value("motorsettings/zaxis/stop_decceleration", 8000.0).toReal());
    m_backlashSpinBox->setValue(m_settings->value("motorsettings/zaxis/backlash", 0.0).toReal());
    m_maxAccelerationSpinBox->setValue(m_settings->value("motorsettings/zaxis/maximum_acceleration", 500.0).toReal());
    m_maxDeccelerationSpinBox->setValue(m_settings->value("motorsettings/zaxis/maximum_decceleration", 500.0).toReal());
    m_maxAccelerationChangeSpinBox->setValue(m_settings->value("motorsettings/zaxis/maximum_acceleration_change", 100.0).toReal());
    m_maxDeccelerationChangeSpinBox->setValue(m_settings->value("motorsettings/zaxis/maximum_decceleration_change", 100.0).toReal());
    m_settings->sync();

    if(m_settings->value("motorsettings/zaxis/negative_turningdirection", 0).toInt() == 0){

        ui->negativeTurningDirectionComboBox->setCurrentIndex(0);
    }

    else if(m_settings->value("motorsettings/zaxis/negative_turningdirection", 0).toInt() == 1){

        ui->negativeTurningDirectionComboBox->setCurrentIndex(1);
    }

    if(m_settings->value("motorsettings/zaxis/positive_turningdirection", 1).toInt() == 0){

        ui->positiveTurningDirectionComboBox->setCurrentIndex(0);
    }
    else if(m_settings->value("motorsettings/zaxis/positive_turningdirection", 1).toInt() == 1){
